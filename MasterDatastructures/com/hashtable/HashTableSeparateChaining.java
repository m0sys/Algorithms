/**
 * Date: 2020/2/15.
 * Implementing Hash Table datastructure based 
 * on William Fiset's ds lecture series. 
 * This version of the hash table uses separate chaining as 
...
public class HashTableSeparateChaining<K, V> implements Iterable<K> {
     ...
     * 
     * Essentially, this strips the negative sign and places the hash value in the
     * domain [0, capacity)
     */
    ...
    /**
     * Removes a key from the table and returns the value.
     * 
     * NOTE: returns null if the value is null AND also returns
    ...
    /**
     * Removes an entry from aa given bucket if it exists.
     */
    ...
    /** Returns a string representating of this hash table. */
    @Override
    ...
    public static void main(String args[]) {
        HashTableSeparateChaining<Character, Integer> ht = new HashTableSeparateChaining<>();
        ht.insert('a', 1);
        ht.insert('a', 2);
        ht.insert('b', 3);
